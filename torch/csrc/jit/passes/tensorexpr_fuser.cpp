...
static const OperatorSet& supported_eltwise_set() {
  ...
  // breaks up the schema strings so they are no longer discoverable with ctrl-F
    static const OperatorSet supported_eltwise_set{
      ...
      "aten::FN_to.dtype(Tensor self, ScalarType dtype, bool non_blocking=False, bool is_csr=False, bool copy=False, MemoryFormat? memory_format=None) -> Tensor",
      ...
      "aten::FN_to.device(Tensor self, Device device, ScalarType dtype, bool non_blocking=False, bool is_csr=False, bool copy=False, MemoryFormat? memory_format=None) -> Tensor",
      ...
      "aten::FN_to.dtype_layout(Tensor self, *, ScalarType? dtype=None, Layout? layout=None, Device? device=None"
      ", bool? pin_memory=None, bool non_blocking=False, bool is_csr=False, bool copy=False, MemoryFormat? memory_format=None) -> Tensor",
