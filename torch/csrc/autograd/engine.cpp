...
auto Engine::execute(const edge_list& roots,
  ...
  if (at::globalContext().FNGlobal.isOnDemand()) {
    ...
    freeBytes = at::native::fn_memorymanager.device_occupancy_size();
    p2pfreeBytes = at::native::fn_memorymanager.p2p_occupancy_size();
  }
  ...
  if(at::globalContext().FNGlobal.isOnDemand())
    at::globalContext().FNGlobal.endOnDemand();
